...
keyset("n", "<C-j>", 'coc#float#has_scroll() ? coc#float#scroll(1, 2) : "<C-d>"', opts)
keyset("n", "<C-k>", 'coc#float#has_scroll() ? coc#float#scroll(0, 2) : "<C-u>"', opts)
-- keyset("i", "<C-j>", 'coc#float#has_scroll() ? "<c-r>=coc#float#scroll(1)<cr>, 2" : "<Right>"', opts)
-- keyset("i", "<C-k>", 'coc#float#has_scroll() ? "<c-r>=coc#float#scroll(0)<cr>, 2" : "<Left>"', opts)
keyset("v", "<C-j>", 'coc#float#has_scroll() ? coc#float#scroll(1, 2) : "<C-d>"', opts)
keyset("v", "<C-k>", 'coc#float#has_scroll() ? coc#float#scroll(0, 2) : "<C-u>"', opts)
...
opts = { silent = true }
keyset('n', '<M-F>', ":call CocAction('format')<Return>", opts)
keyset('i', '<M-F>', "<ESC>:call CocAction('format')<Return>", opts)
keyset('v', '<M-F>', "<ESC>:call CocAction('formatSelected', visualmode())<Return>", opts)
keyset('x', '<M-F>', "<ESC>:call CocAction('formatSelected', visualmode())<Return>", opts)
